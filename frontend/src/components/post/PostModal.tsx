...
export function PostModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="w-[calc(100%-2rem)] sm:max-w-xl md:max-w-2xl max-w-2xl max-h-[80vh] overflow-y-auto border-0 bg-transparent backdrop-blur-none p-0 shadow-none">
