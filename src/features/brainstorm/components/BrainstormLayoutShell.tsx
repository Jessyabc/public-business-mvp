...
export function BrainstormLayoutShell({
  ...
  return <div className={cn('flex h-full flex-col', className)}>
      ...
      {/* Desktop: 2-column layout (main + sidebar, no cross-links) */}
      <div className="hidden h-full min-h-0 gap-4 lg:grid lg:grid-cols-[minmax(0,1fr)_minmax(200px,240px)] px-[10px] py-[10px]">
