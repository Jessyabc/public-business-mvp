 ...
 * - Two-column grid: 70% Canvas + 30% Sidebar
 * - Soft links remain inside SpaceCanvas on the left
...
export default function BrainstormFeed() {
  ...
  return (
    <main className="relative h-screen w-full overflow-hidden grid grid-cols-1 lg:grid-cols-[70fr_30fr] gap-8 p-8">
      <GlobalBackground />
      
      {/* LEFT/CENTER: Canvas with soft links inside */}
      <section className="relative flex flex-col rounded-3xl bg-background/5 backdrop-blur-md border border-foreground/10 shadow-inner overflow-hidden">
      ...
      <aside className="relative flex flex-col rounded-3xl bg-background/5 backdrop-blur-md border border-foreground/10 shadow-inner overflow-hidden">
