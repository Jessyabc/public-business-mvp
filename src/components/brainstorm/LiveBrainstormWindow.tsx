...
import { useBrainstorms, type Brainstorm, type BrainstormStats } from '@/hooks/useBrainstorms';
...
const BrainstormBubble = memo(({ brainstorm, stats, dense = false, onNavigate }: BrainstormBubbleProps) => {
          ...
          >
            ...
            >
              <div className="space-y-3">
                ...
                {stats && (stats.likes_count > 0 || stats.comments_count > 0) && (
