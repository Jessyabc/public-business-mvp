  ...
  return (
    <>
      <Button
        ...
        className={`fixed bottom-6 left-[calc(50%+300px)] w-16 h-16 rounded-full glass-card backdrop-blur-xl transition-all duration-300 hover:scale-110 z-40 border ${
          mode === 'public'
