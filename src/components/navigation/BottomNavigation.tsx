    ...
    <>
              ...
              return (
                <NavLink
                  ...
                  className={`relative flex flex-col items-center space-y-0.5 sm:space-y-1 px-1.5 sm:px-2 py-1.5 sm:py-2 rounded-xl transition-all duration-med glass-nav-item ${
                    isActive ? 'bg-pb-blue/20 text-white' : 'text-pb-text2 hover:text-pb-text0 hover:bg-white/10'
                  }`}
                >
      ...
      <nav className="md:hidden fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 w-auto">
        <div className={`glass-card rounded-full px-4 py-3 flex items-center gap-2 border-2 border-white/20 backdrop-blur-xl bg-white/10`}>
          ...
          <Button
            onClick={() => openComposer()}
            className={`w-10 h-10 rounded-full bg-pb-blue/20 hover:bg-pb-blue/30 text-white border border-pb-blue/30`}
            size="icon"
          >
